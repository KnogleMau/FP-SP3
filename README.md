...
| **GET** | `/trips/{id}` | Get a specific product by ID | ✅ | USER, ADMIN |
| **GET** | `/trips/guides/totalprice` | Get total price for all guides | ✅ | USER, ADMIN |
| **GET** | `/trips/{id}/packing/weight` | Get total packing weight for a product | ✅ | USER, ADMIN |
| **POST** | `/trips` | Create a new product | ✅ | ADMIN |
| **PUT** | `/trips/{id}` | Update an existing product | ✅ | ADMIN |
| **PUT** | `/trips/{tripId}/guides/{guideId}` | Add a receipt to a product | ✅ | ADMIN |
| **DELETE** | `/trips/{id}` | Delete a product | ✅ | ADMIN |
